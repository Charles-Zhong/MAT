# usage: MAT.py      [-h] [--task_name {CoLA,SST-2,MRPC,STS-B,QQP,MNLI-m,MNLI-mm,QNLI,RTE,WNLI,CQA,ANLI}]]
...
#                    [--beta_s BETA_S] [--beta_p BETA_P] [--save_model SAVE_MODEL] [--eval_times EVAL_TIMES]
#!/bin/bash
