...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="bert-base-uncased", choices=["bert-base-uncased", "roberta-base" ,"roberta-large"],help="Finetune base model.")
    parser.add_argument("--seed", type=int, default=42, help="A seed for reproducible training.")
    parser.add_argument("--batch_size", type=int, default=64, help="Batch size for the training dataloader.")
    parser.add_argument("--epochs", type=int, default=5, help="Total number of training epochs to perform.")
    parser.add_argument("--adv_init_epsilon", type=float, default=0.01, help="Initialization size of adversarial perturbation.")
    ...
    parser.add_argument("--sampling_step_theta", type=float, default=0.01, help="Stochastic gradient langevin dynamics sampling step for model parameters.")
    parser.add_argument("--sampling_step_delta", type=float, default=0.001, help="Stochastic gradient langevin dynamics sampling step for adversarial perturbation.")
    ...
    parser.add_argument("--save_model", type=bool, default=False, help="Save the best model during training.")
